		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#student24saptraininghelloworld-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"student24saptraininghelloworld-display": {
								"semanticObject": "student24saptraininghelloworld",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=student24.sap.training.helloworld",
									"url": sap.ui.require.toUrl("student24/sap/training/helloworld")
								}
							}
						}
					}
